...
test("injects the overlay and sends result messages when enabled", async () => {
  ...
  assert.deepEqual(calls[0], ["executeScript", {
    target: { tabId: 7 },
    files: ["src/content/overlay-style.js", "src/content/overlay-runtime-adapters.js", "src/content/overlay-language.js", "src/content/overlay-result-view.js", "src/content-overlay.js"]
  }]);
