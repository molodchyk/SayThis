...
test("collects only extension runtime package files", async () => {
  ...
  assert.ok(files.includes("src/background/sources/online-sources.js"));
  assert.ok(files.includes("src/background/runtime/runtime-platform.js"));
  assert.ok(files.includes("src/content/overlay-language.js"));
  ...
  assert.ok(files.includes("src/resolver/audio.js"));
  assert.ok(files.includes("src/resolver/community.js"));
  assert.ok(files.includes("src/resolver/language.js"));
  assert.ok(files.includes("src/resolver/status.js"));
  ...
  assert.ok(files.includes("src/wikidata/pronunciation-audio.js"));
  assert.ok(files.includes("src/wikidata/source-forms.js"));
